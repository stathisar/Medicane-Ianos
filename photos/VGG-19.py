...
#==========================================================================
#TRAIN
# Import originalVGG-19 with pretrained weights
vgg19 = models.vgg19(pretrained=True)
for param in vgg19.parameters():
    param.requires_grad = False
    # Replace last fully connected layer (classifier)
    vgg19.classifier[6] = nn.Linear(4096, 1)  # Binary classification (1 output)

device=torch.device("cuda" if torch.cuda.is_available() else "cpu")
vgg19=vgg19.to(device)
criterion = nn.BCEWithLogitsLoss()  # Binary cross entropy loss
optimizer = optim.Adam(vgg19.classifier[6].parameters(), lr=0.001)  # Training the new layer
val_last = 0
...
for epoch in range(100):  # 100 epochs
	...
	if abs(train_accuracy - val_accuracy) < 10 and val_accuracy > val_last:
		torch.save(vgg19, '/media/stathis/StathisUSB/final_classification_march_9/models/vgg/vgg_best_finetuned_iter1.pth')
...
#save metrics
metrics.to_csv('/media/stathis/StathisUSB/final_classification_march_9/models/vgg/vgg_metrics_apr13.csv')
#save model
torch.save(vgg19, '/media/stathis/StathisUSB/final_classification_march_9/models/vgg/vgg_finetuned_last_version__not_best_apr_13.pth')
#=========================================================
...
#=====================
#Predict
vgg19 = torch.load('/media/stathis/StathisUSB/final_classification_march_9/models/vgg/vgg_best_finetuned_iter1.pth', weights_only=False)
...
with torch.no_grad():
    ...
    for images, _, paths in pred_loader:  # Returning paths as well
        ...
        outputs = vgg19(images)  # Outputs in a schema (batch_size, 2)
...
results_df.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/vgg19_predictions.apr.13.5078_.csv', index=False)
results_df_sample = results_df.sample(n=150)
results_df_sample.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/vgg19_predictions_apr_13_sample_150.csv', index=False)
