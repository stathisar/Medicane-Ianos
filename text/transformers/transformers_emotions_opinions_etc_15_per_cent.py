...
labels = df_cons['emotions_opinions_etc'].values
...
checkpoint_path = "/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_emotions_best_model.pt"  # Filepath to save the best model
...
loss_stats.to_csv('/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_stats_emotions.csv')
torch.save(model.state_dict(), '/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_emotions.pth')
...
checkpoint_path = "/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_emotions_best_model.pt"
...
data.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/15/transformers_emotions.csv', index=False)
