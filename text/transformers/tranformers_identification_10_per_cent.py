...
checkpoint_path = "/media/stathis/StathisUSB/final_classification_march_9/models/10/transformers_identification_best_model.pt"  # Filepath to save the best model
...
loss_stats.to_csv('/media/stathis/StathisUSB/final_classification_march_9/models/10/transformers_stats_identification.csv')
torch.save(model.state_dict(), '/media/stathis/StathisUSB/final_classification_march_9/models/10/transformers_identification.pth')
...
data.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/10/transformers_identification.csv', index=False)
