...
checkpoint_path = "/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_dm_best_model.pt"  # Filepath to save the best model
...
loss_stats.to_csv('/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_stats_dm.csv')
torch.save(model.state_dict(), '/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_dm.pth')
...
checkpoint_path = "/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_dm_best_model.pt"
...
data.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/15/transformers_dm.csv', index=False)
