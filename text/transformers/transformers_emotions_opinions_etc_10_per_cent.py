...
checkpoint_path = "/media/stathis/StathisUSB/final_classification_march_9/models/10/transformers_opinions_best_model.pt"  # Filepath to save the best model
...
loss_stats.to_csv('/media/stathis/StathisUSB/final_classification_march_9/models/10/transformers_stats_opinions.csv')
torch.save(model.state_dict(), '/media/stathis/StathisUSB/final_classification_march_9/models/10/transformers_opinions.pth')
...
data.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/10/transformers_opinions.csv', index=False)
