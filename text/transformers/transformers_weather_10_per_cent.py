...
checkpoint_path = "/media/stathis/StathisUSB/final_classification_march_9/models/10/transformers_weather_best_model.pt"  # Filepath to save the best model
...
loss_stats.to_csv('/media/stathis/StathisUSB/final_classification_march_9/models/10/transformers_stats_weather.csv')
torch.save(model.state_dict(), '/media/stathis/StathisUSB/final_classification_march_9/models/10/transformers_weather.pth')
...
data.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/10/transformers_weather.csv', index=False)
