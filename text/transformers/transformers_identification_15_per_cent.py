...
# Load dataset
df_cons = pd.read_csv("/media/stathis/StathisUSB/final_classification_march_9/training_data/new_version_merged_complete_march_21_all_sources_no_duplicates.csv")
texts = df_cons['translated'].values
labels = df_cons['identification'].values
...
checkpoint_path = "/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_identification_best_model.pt"  # Filepath to save the best model
...
loss_stats.to_csv('/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_stats_identification.csv')
torch.save(model.state_dict(), '/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_identification.pth')
...
checkpoint_path = "/media/stathis/StathisUSB/final_classification_march_9/models/15/transformers_identification_best_model.pt"
...
data.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/15/transformers_identification.csv', index=False)
