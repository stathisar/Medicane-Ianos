...
custom_checkpoint = CustomCheckpoint(
    filepath='/media/stathis/StathisUSB/final_classification_march_9/models/15/lstm_emotions_best_model.h5',
...
# Callbacks
csv_logger = CSVLogger('/media/stathis/StathisUSB/final_classification_march_9/models/15/emotions_model_log.csv', append=False)
...
best_model = load_model('/media/stathis/StathisUSB/final_classification_march_9/models/15/lstm_emotions_best_model.h5')
...
df.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/15/emotions_lstm.csv')
