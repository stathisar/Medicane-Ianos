...
#set wd
os.chdir('/path-to-data-script-workspace')
# Load and preprocess your data

df = pd.read_csv('./training_data/text/10.per.cent/training_792.csv')
...
custom_checkpoint = CustomCheckpoint(
    filepath='/media/stathis/KINGSTON/ML-Water/filtered_data/final_classification_march_9/models/10/lstm_consequences_best_model.h5',
...
# Save predictions
data_predict = pd.read_csv('/media/stathis/KINGSTON/ML-Water/filtered_data/final_classification_march_9/text_data/DataTextAllSources_March_15_Removed_duplicates.csv')
...
best_model = load_model('/media/stathis/KINGSTON/ML-Water/filtered_data/final_classification_march_9/models/10/lstm_consequences_best_model.h5')
...
df.to_csv('/media/stathis/KINGSTON/ML-Water/filtered_data/final_classification_march_9/results/10/consequences_lstm.csv'
