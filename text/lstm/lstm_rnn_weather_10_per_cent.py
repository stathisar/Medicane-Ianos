...
custom_checkpoint = CustomCheckpoint(
    filepath='/media/stathis/StathisUSB/final_classification_march_9/models/10/lstm_weather_best_model.h5',
...
# Callbacks
csv_logger = CSVLogger('/media/stathis/StathisUSB/final_classification_march_9/models/10/weather_model_log.csv', append=False)
...
best_model = load_model('/media/stathis/StathisUSB/final_classification_march_9/models/10/lstm_weather_best_model.h5')
...
df.to_csv('/media/stathis/StathisUSB/final_classification_march_9/results/10/weather_lstm.csv'
