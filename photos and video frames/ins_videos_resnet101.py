...
datasetPredict = CustomImageFolder(
    root='/home/stathis/Desktop/Research/revising_Ianos/ins_video_frame_data',
    transform=transform
)
...
results_df.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/resnet_ins_videos_predictions_oct25.csv', index=False)
results_df.sample(n=150).to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/resnet_ins_videos_predictions_oct25_sample_150.csv', index=False)
