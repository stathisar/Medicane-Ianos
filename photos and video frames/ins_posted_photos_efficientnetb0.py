...
results_df.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/efficientnetb0_oct26_instagram_posted_photos.csv', index=False)
results_df_sample = results_df.sample(n=150)
results_df_sample.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/efficientnetb0_oct26_instagram_posted_photos_sample_150.csv', index=False)
