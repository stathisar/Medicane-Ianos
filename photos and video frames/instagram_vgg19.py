...
datasetPredict = CustomImageFolder(root='/home/stathis/Desktop/Research/revising_Ianos/filtered/ins_posted_photos', transform=transform)
...
results_df.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/vgg19_instagram_posted_photos_oct26.csv', index=False)
results_df_sample = results_df.sample(n=150)
results_df_sample.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/instagram_posted_photos_vgg19_oct26_sample_150.csv', index=False)
