...
datasetPredict = CustomImageFolder(
    root='/media/stathis/cf72d5ad-7505-4023-a7e0-1505a375278d/Research Data/Social Media/youtube_time_frames_Ianos/all_youtube_frames/',
    transform=transform
)
...
results_df.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/resnet_predictions_oct22.csv', index=False)
results_df.sample(n=150).to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/resnet_predictions_oct22_sample_150.csv', index=False)
