#=====================
#Frames Predict on finetuned vgg19
...
vgg19 = torch.load('/home/stathis/Desktop/Research/revising_Ianos/data_scripts_models/vgg-19/vgg_best_finetuned_iter1.pth', weights_only=False)
datasetPredict = CustomImageFolder(root='/media/stathis/cf72d5ad-7505-4023-a7e0-1505a375278d/Research Data/Social Media/youtube_time_frames_Ianos/all_youtube_frames/', transform=transform)
...
results_df.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/frames_vgg19_oct22.csv', index=False)
results_df_sample = results_df.sample(n=150)
results_df_sample.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/frames_vgg19_oct22_sample_150.csv', index=False)
