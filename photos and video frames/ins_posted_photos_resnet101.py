...
datasetPredict = CustomImageFolder(
    root='/home/stathis/Desktop/Research/revising_Ianos/filtered/ins_posted_photos',
    transform=transform
)
...
results_df.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/resnet_ins_posted_photos_predictions_oct26.csv', index=False)
results_df.sample(n=150).to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/resnet_ins_posted_photos_predictions_oct26_sample_150.csv', index=False)
