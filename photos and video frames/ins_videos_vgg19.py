...
datasetPredict = CustomImageFolder(root='/home/stathis/Desktop/Research/revising_Ianos/ins_video_frame_data', transform=transform)
...
results_df.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/frames_vgg19_ins_videos_oct25.csv', index=False)
results_df_sample = results_df.sample(n=150)
results_df_sample.to_csv('/home/stathis/Desktop/Research/revising_Ianos/task-frames-predict-with-retrained-models/frames_ins_videos_vgg19_oct25_sample_150.csv', index=False)
