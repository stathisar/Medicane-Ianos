...
# Load dataset
df_cons = pd.read_csv("/media/stathis/cf72d5ad-7505-4023-a7e0-1505a375278d/a little map/final_classification_march_9/training_data/training_792.csv")
...
checkpoint_path = "/home/stathis/Desktop/results/models/10/transformers_dm_best_model.pt"  # Filepath to save the best model
...
loss_stats.to_csv('/home/stathis/Desktop/results/models/10/transformers_stats_dm.csv')
torch.save(model.state_dict(), '/home/stathis/Desktop/results/models/10/transformers_dm.pth')

#predict

# Load CSV
data = pd.read_csv('/media/stathis/cf72d5ad-7505-4023-a7e0-1505a375278d/a little map/final_classification_march_9/text_data/DataTextAllSources_March_15_Removed_duplicates.csv')
...
# Save as CSV
data.to_csv('/home/stathis/results/10/transformers_dm.csv', index=False)
